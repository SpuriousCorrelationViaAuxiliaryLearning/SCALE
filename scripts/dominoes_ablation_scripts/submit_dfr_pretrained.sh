...
python retrain.py --dataset=$dataset --val_target_size=$val_target_size --spurious_strength=$spurious_strength --seed=$seed --data_dir=/hpctmp/e0200920/mcdominoes_data --output_dir=/hpctmp/e0200920/DFR-pretrained-$dataset-$spurious_strength-$val_target_size-$seed
