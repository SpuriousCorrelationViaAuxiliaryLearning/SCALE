...
python retrain.py --dataset=$dataset --val_target_size=$val_target_size --spurious_strength=$spurious_strength --ckpt_path=/hpctmp/e0200920/method_0_ablation/0-$dataset-$spurious_strength-$val_target_size-$weight_decay-$batch_size-$init_lr-$seed/best_checkpoint.pt --seed=$seed --data_dir=/hpctmp/e0200920/mcdominoes_data --output_dir=/hpctmp/e0200920/DFR-$dataset-$spurious_strength-$val_target_size-$weight_decay-$batch_size-$init_lr-$seed
