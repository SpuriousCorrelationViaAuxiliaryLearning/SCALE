...
python train.py --pretrained_model --num_epochs 100 --method=$method --dataset=$dataset --spurious_strength=$spurious_strength --val_target_size=$val_target_size --weight_decay=$weight_decay --batch_size=$batch_size --init_lr=$init_lr --seed=$seed --data_dir=/hpctmp/e0200920/celeba --output_dir=/hpctmp/e0200920/$method-$dataset-$spurious_strength-$val_target_size-$weight_decay-$batch_size-$init_lr-$seed
